    ...
    public Mazo siguienteCarta(ArrayList<Carta> cartas, Mazo masoCartas) {
        ...
        do {
            ...
            if (indiceActual < cartas.size()) {
                ...
                mazoRepartido.add(c);
                //cartas.remove(c);
                System.out.println("Carta N° "+(indiceActual+1)+" "+c);
                indiceActual++;
                //System.out.println(indiceActual);
...
//debemos indicárselo al usuario.
    ...
    public void darCartas(ArrayList<Carta> cartas, Mazo masoCartas){
//        
//        int cantidad;
//        
//        System.out.println("Ingrese la cantidad de cartas que quiere repartir");
//        
//        cantidad = leer.nextInt();
//        
//        if (cantidad>cartas.size()) {
//            System.out.println("La cantidad de cartas no alcanza");
//        }else{
...
//                System.out.println(cartas.size());
//                System.out.println(indiceActual);
//                masoCartas.setCartasRepartidas(masoCartas.getCartasRepartidas());
//                
//                //cartas.remove(c);
//                System.out.println("Carta N° "+(indiceActual+1)+" "+c);
//                indiceActual++;
...
>>>>>>> 300d5dc344d752adde9cc5d25ecbd164852cbea2
